...
def iterate_paginated_API(function: Callable, first_page_args: Dict[Any, Any]) -> Generator:
    ...
    while True:
        ...
        if (not response['has_more']) | (next_cursor == None):
            return


def collect_paginated_API(function: Callable, first_page_args: Dict[Any, Any]) -> List[Any]:
...
async def async_iterate_paginated_API(function: Callable, first_page_args: Dict[Any, Any]) -> AsyncGenerator:
...
async def async_collect_paginated_API(function: Callable, first_page_args: Dict[Any, Any]) -> List[Any]:
